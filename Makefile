...
regress_quick: clean simple_test io_test ping_pong_test mutex_test barrier_test cannon_msg cannon cannon_msg_dist simple_test_dist ring_msg_pass dynamic_threads spawn_join
