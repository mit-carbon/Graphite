...
OCache::OCache(std::string name, Core *core)
      :
      m_dl1(new RRSACache(name + "_dl1", g_knob_dcache_size.Value() * k_KILO, g_knob_cache_line_size.Value(), g_knob_dcache_associativity.Value(), g_knob_dcache_max_search_depth.Value())),
      m_il1(new RRSACache(name + "_il1", g_knob_icache_size.Value() * k_KILO, g_knob_cache_line_size.Value(), g_knob_icache_associativity.Value(), g_knob_icache_max_search_depth.Value())),
      m_cache_size(g_knob_cache_size.Value() * k_KILO),
      m_line_size(g_knob_cache_line_size.Value()),
