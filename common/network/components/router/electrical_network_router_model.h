...
public:
   ...
   ElectricalNetworkRouterModel(float frequency, UInt32 num_input_ports, UInt32 num_output_ports, UInt32 num_flits_per_buffer, UInt32 flit_width);
   ~ElectricalNetworkRouterModel();

   // Update Dynamic Energy
   void updateDynamicEnergyBuffer(BufferAccess::Type buffer_access_type, UInt32 num_bit_flips, UInt32 num_flits = 1)
   {
