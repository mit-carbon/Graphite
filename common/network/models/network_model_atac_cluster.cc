...
UInt32 NetworkModelAtacCluster::m_total_tiles = 0;
...
NetworkModelAtacCluster::getHubQueueDelay(NetworkComponentType hub_type, SInt32 sender_cluster_id, SInt32 cluster_id, UInt64 pkt_time, const NetPacket& pkt)
{
   ...
   NetworkModelAtacCluster* network_model = (NetworkModelAtacCluster*) tile->getNetwork()->getNetworkModelFromPacketType(pkt.type);
...
SInt32
NetworkModelAtacCluster::getClusterID(tile_id_t tile_id)
{
...
tile_id_t
NetworkModelAtacCluster::getTileIDWithOpticalHub(SInt32 cluster_id)
{
   // Consider a mesh formed by the clusters
   SInt32 cluster_mesh_width;
   cluster_mesh_width = m_mesh_width / m_sqrt_cluster_size;
...
void
NetworkModelAtacCluster::getTileIDListInCluster(SInt32 cluster_id, vector<tile_id_t>& tile_id_list)
{
   SInt32 cluster_mesh_width;
   cluster_mesh_width = m_mesh_width / m_sqrt_cluster_size;
...
pair<bool,SInt32>
NetworkModelAtacCluster::computeTileCountConstraints(SInt32 tile_count)
{
...
NetworkModelAtacCluster::computeMemoryControllerPositions(SInt32 num_memory_controllers, SInt32 tile_count)
{
...
NetworkModelAtacCluster::computeProcessToTileMapping()
{
   // Initialize m_total_tiles, m_cluster_size, m_sqrt_cluster_size, m_mesh_width, m_mesh_height, m_num_clusters
   initializeANetTopologyParams();
