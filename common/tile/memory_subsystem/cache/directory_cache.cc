   ...
   , _enabled(false)
{
   ...
   {
      _cache_power_model = new CachePowerModel("directory", _total_entries * directory_entry_size,
   ...
   {
      _cache_area_model = new CacheAreaModel("directory", _total_entries * directory_entry_size,
            directory_entry_size, _associativity, _dram_directory_cache_access_delay_in_clock_cycles, core_frequency);
   }
