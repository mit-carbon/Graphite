...
void
DramCntlr::handleMsgFromDramDirectory(tile_id_t sender, ShmemMsg* shmem_msg)
{
   ...
   case ShmemMsg::DRAM_FETCH_REQ:
      {
         ...
         ShmemMsg dram_reply(ShmemMsg::DRAM_FETCH_REPLY, MemComponent::DRAM_CNTLR, MemComponent::DRAM_DIRECTORY,
                             address, data_buf, _cache_line_size,
