...
namespace DSENT
{
    ...
    void ModelGen::printAvailableModels(ostream& ost_)
    {
        // TODO: Need more descriptions
        ost_ << "INV NAND2 NOR2 MUX2 XOR2 DFFQ LATQ ADDF OR2 AND2 BUF" << endl;
        ost_ << "RippleAdder Multiplexer OR RepeatedLink BroadcastHTree" << endl;
        ost_ << "MultiplexerCrossbar Decoder DFFRAM MatrixArbiter SeparableAllocator Router" << endl;
        ost_ << "OpticalLinkBackendTx OpticalLinkBackendRx SWMRLink SWSRLink" << endl;
        ost_ << "LaserSource ThrottledLaserSource RingModulator RingDetector" << endl;
        ost_ << "ElectricalMesh ElectricalClos PhotonicClos" << endl;
        return;
    }
} // namespace DSENT
