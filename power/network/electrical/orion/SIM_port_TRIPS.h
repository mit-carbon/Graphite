...
#define PARM_out_port		3	/* # of network output ports */
...
#define PARM_v_channel		2	/* # of network port virtual channels */
...
/* ?? */
#define PARM_in_share_switch	0	/* do input virtual channels share crossbar input ports? */
...
#define PARM_exp_in_seg         0
#define PARM_exp_out_seg        0

/* input buffer parameters */
#define PARM_in_buf		1	/* have input buffer? */
#define PARM_in_buf_set		8	/* # of rows */
