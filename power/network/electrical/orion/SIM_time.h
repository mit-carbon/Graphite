...
extern double SIM_gatecap(double width, double wirelength);
extern double SIM_gatecappass(double width, double wirelength);
extern double SIM_draincap(double width, int nchannel, int stack);
extern double SIM_restowidth(double res, int nchannel);
